...
public class JoinGroup {
    public static void joinExistingGroup(GroupManager groupManager, User loggedInUser) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            // Check groupManager to find the group to see if it exists
            ...
            // Display the details of the group to the user to confirm
            ...
            System.out.println("Hello, " + memberName + "! Your monthly contribution for this group will be: $" + group.getMonthlySavingsPerMember());
